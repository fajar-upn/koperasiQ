  ...
  <div class="card p-2">
    <div class="row mb-2">
      <div class="col text-center">
         <h2 class="text-dark"><strong>Daftar Simpanan <?= $user?>, id : <?= $id ?> </strong></h2>
    ...
    <!-- <div class="row mt-2">
        <div class="col">
          <div class="row mt-2">
            ...
            <div class="col-2">
              <form style="margin-bottom: 0;" method="post" action="<?= base_url('admin/cetak_simpanan');?>" target="_blank">
                   ...
                   <table class="table table-bordered table-hover" id="example1" width="100%" cellspacing="0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?= rupiah($da['simpanan_sukarela']) ?></td>gg
